...
OBJECTS = """
    ...
    <geom name="region_red" type="box" pos="0.30 0.20 0.006" size="0.04 0.04 0.003" rgba="0.9 0.1 0.1 0.45" contype="0" conaffinity="0" />
    <geom name="region_blue" type="box" pos="0.62 0.20 0.006" size="0.04 0.04 0.003" rgba="0.1 0.3 0.9 0.45" contype="0" conaffinity="0" />
